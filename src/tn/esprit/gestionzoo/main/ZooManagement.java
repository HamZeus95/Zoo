...
//        myZoo.displayAnimals();
        ...
        Animal dog2 = new Animal("Canine 2", "Snoopy", -2, true);
        Animal dog3 = new Animal("Canine 3", "Snoopy", 2, true);
        Animal dog4 = new Animal("Canine 4", "Snoopy", 2, true);
        Animal dog5 = new Animal("Canine 5", "Snoopy", 2, true);
        myZoo.addAnimal(dog);
        try{
            myZoo.addAnimal(dog2);
